            ...
            >
              ...
              {showProjects && (
                <div className="project-list">
                  ...
                  <Link href="" target="_blank" rel="noopener noreferrer" onClick={() => setShowProjects(false)}>HBD Celebration App</Link>
                  <Link href="https://project-5-calcula" target="_blank" rel="noopener noreferrer" onClick={() => setShowProjects(false)}>iOS Calculator</Link>
