            ...
            >
              ...
              {showProjects && (
                <div className="project-list">
                  ...
                  <Link href="" target="_blank" rel="noopener noreferrer" onClick={() => setShowProjects(false)}>iOS Calculator</Link>
                  <Link href="" target="_blank" rel="noopener noreferrer" onClick={() => setShowProjects(false)}>GenAI Website</Link>
                </div>
              )}
            </li>
          </ul>
